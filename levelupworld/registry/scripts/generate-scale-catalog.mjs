 ...
 * Does not inflate the certified gateway portfolio — scale UI fixtures stay separate.
 * Gateway certified/sandboxed manifests are generated by `generate-connectors.mjs`.
 */
