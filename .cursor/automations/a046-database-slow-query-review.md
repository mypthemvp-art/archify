---
id: A046
title: Database slow-query review
plugin: production-triage-copilot
plugins: [production-triage-copilot, database-change-guardian]
mutation: plan
phase: 2
status: blueprint
...
# A046 — Database slow-query review
...
Postgres read-only, telemetry

## Output and guardrail

Query plan findings; approval for indexes
