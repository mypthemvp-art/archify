---
id: A091
title: OpenAI MCP server scaffold generator
...
# A091 — OpenAI MCP server scaffold generator
...
OpenAI MCPKit template, filesystem

## Output and guardrail

Authenticated TypeScript/Python server skeleton
