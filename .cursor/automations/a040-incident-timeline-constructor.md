---
id: A040
title: Incident timeline constructor
plugin: production-triage-copilot
plugins: [production-triage-copilot]
mutation: none
phase: 1
status: blueprint
...
# A040 — Incident timeline constructor
...
Slack/alerts/logs/traces

## Output and guardrail

Timestamped chronology; redact PII
...
1. Load `.cursor/skills/levelupworld/production-triage-copilot/SKILL.md` (and the catalog router if needed).
