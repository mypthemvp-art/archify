---
id: A054
title: Experiment analysis brief
plugin: featureops
plugins: [featureops]
mutation: plan
phase: 2
...
# A054 — Experiment analysis brief
...
analytics read, flag platform

## Output and guardrail

Guardrail metrics + decision template
...
1. Load `.cursor/skills/levelupworld/featureops/SKILL.md` (and the catalog router if needed).
