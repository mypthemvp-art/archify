---
id: A052
title: Funnel regression investigator
plugin: unassigned
plugins: []
mutation: none
phase: 1
...
# A052 — Funnel regression investigator
...
analytics read, deployments

## Output and guardrail

Correlated release and segment analysis
...
1. Load `.cursor/skills/levelupworld/levelupworld-catalog-router/SKILL.md` (and the catalog router if needed).
