---
id: A095
title: MCP response redaction gateway
plugin: mcp-security-gateway
plugins: [mcp-security-gateway, privacy-engineering]
mutation: none
phase: 1
status: blueprint
...
# A095 — MCP response redaction gateway
...
policy/redaction MCP

## Output and guardrail

Token/PII/secret scrubbing before model context
...
1. Load `.cursor/skills/levelupworld/mcp-security-gateway/SKILL.md` (and the catalog router if needed).
