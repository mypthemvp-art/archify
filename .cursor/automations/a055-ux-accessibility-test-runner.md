---
id: A055
title: UX accessibility test runner
plugin: accessibility-qa
plugins: [accessibility-qa]
mutation: none
phase: 1
status: blueprint
...
# A055 — UX accessibility test runner
...
Playwright, axe, browser

## Output and guardrail

WCAG-oriented findings with screenshots/artifacts
...
1. Load `.cursor/skills/levelupworld/accessibility-qa/SKILL.md` (and the catalog router if needed).
