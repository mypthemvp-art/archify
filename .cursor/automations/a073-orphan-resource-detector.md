---
id: A073
title: Orphan-resource detector
plugin: cloud-cost-governor
plugins: [cloud-cost-governor]
mutation: plan
phase: 2
status: blueprint
...
cloud inventory, IaC state

## Output and guardrail

Candidate cleanup plan; human approval needed
...
1. Load `.cursor/skills/levelupworld/cloud-cost-governor/SKILL.md` (and the catalog router if needed).
