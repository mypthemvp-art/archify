---
id: A088
title: Regulatory-change watchlist
plugin: compliance-evidence-engine
plugins: [compliance-evidence-engine, open-source-maintenance]
mutation: none
phase: 1
status: blueprint
...
# A088 — Regulatory-change watchlist
...
web fetch/search, policy library

## Output and guardrail

Relevant changes + impact hypotheses
...
4. **Approval:** required for production writes, external communications, deletes, migrations, or spending. Mutation class: `none`.
...
1. Load `.cursor/skills/levelupworld/compliance-evidence-engine/SKILL.md` (and the catalog router if needed).
