---
id: A098
title: Prompt-injection content firewall
plugin: mcp-security-gateway
plugins: [mcp-security-gateway]
mutation: none
phase: 1
status: blueprint
...
# A098 — Prompt-injection content firewall
...
fetch proxy, classifier, policy

## Output and guardrail

Treat content as data; isolate untrusted instructions
