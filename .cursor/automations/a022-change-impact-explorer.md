...
plugin: repository-intelligence
plugins: [repository-intelligence]
mutation: none
phase: 1
status: blueprint
...
git, code graph, GitHub

## Output and guardrail

Callers, services, migrations, dashboards
...
1. Load `.cursor/skills/levelupworld/repository-intelligence/SKILL.md` (and the catalog router if needed).
