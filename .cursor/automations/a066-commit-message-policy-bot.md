---
id: A066
title: Commit-message policy bot
plugin: open-source-maintenance
...
# A066 — Commit-message policy bot
...
1. Load `.cursor/skills/levelupworld/open-source-maintenance/SKILL.md` (and the catalog router if needed).
