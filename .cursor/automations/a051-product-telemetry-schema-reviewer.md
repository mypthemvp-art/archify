---
id: A051
title: Product telemetry schema reviewer
plugin: privacy-engineering
plugins: [privacy-engineering]
mutation: none
phase: 1
status: blueprint
...
# A051 — Product telemetry schema reviewer
...
analytics schema, privacy policy
...
1. Load `.cursor/skills/levelupworld/privacy-engineering/SKILL.md` (and the catalog router if needed).
