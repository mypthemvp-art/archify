---
id: A098
title: External doc fetch with injection guard
...
# A098 — External doc fetch with injection guard
...
Web fetch via gateway

## Expected output

Safe summary + sources

## Key guardrail

Sandbox untrusted HTML/MD
