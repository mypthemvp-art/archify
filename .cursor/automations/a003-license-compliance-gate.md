---
id: A003
title: License compliance gate
plugin: secure-pr-guardian
plugins: [secure-pr-guardian]
mutation: none
phase: 1
status: blueprint
...
dependency scanner, policy MCP

## Output and guardrail

Pass/fail report; block restricted licenses
...
1. Load `.cursor/skills/levelupworld/secure-pr-guardian/SKILL.md` (and the catalog router if needed).
